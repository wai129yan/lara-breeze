            ...
            <form action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <select name="tags[]" id="tags" multiple
                        ...
                        @foreach ($tags as $tag)
                            <option value="{{ $tag->id }}"
                                {{ old('tags') && in_array($tag->id, old('tags', $post->tags->pluck('id')->toArray())) ? 'selected' : '' }}>
                                {{ $tag->name }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="relative">
                            <img id="image-preview"
                                src="{{ $post->featured_image ? asset('storage/' . $post->featured_image) : '/placeholder.svg?height=150&width=250' }}"
