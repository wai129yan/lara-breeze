    ...
    <div class="bg-white border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="flex items-center text-sm">
                <a href="#" class="breadcrumb-arrow text-gray-500 hover:text-gray-700">Home</a>
                <a href="#" class="breadcrumb-arrow text-gray-500 hover:text-gray-700">Categories</a>
    ...
    <section class="gradient-bg text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="max-w-3xl mx-auto">
                ...
                <h1 class="text-4xl md:text-5xl font-bold mb-4">JavaScript Articles</h1>
                ...
                <div class="flex flex-wrap justify-center gap-4 text-sm">
                    <div class="bg-white bg-opacity-20 px-4 py-2 rounded-full">
                        ...
                        <span id="articleCount">127 Articles</span>
                    </div>
                    <div class="bg-white bg-opacity-20 px-4 py-2 rounded-full">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="articlesGrid" class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article class="article-card card-hover bg-white rounded-lg shadow-lg overflow-hidden fade-in"
                    data-title="JavaScript ES2024: New Features You Should Know" data-author="Sarah Johnson"
                    data-date="2024-12-15" data-views="2300" data-difficulty="intermediate" data-tags="es6,performance">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">
                            ...
                            including new syntax and performance improvements.
                        </p>
                ...
                <!-- Article 2 -->
                <article class="article-card card-hover bg-white rounded-lg shadow-lg overflow-hidden fade-in"
                    data-title="Node.js Best Practices for 2024" data-author="Mike Chen" data-date="2024-12-12"
                    data-views="1800" data-difficulty="advanced" data-tags="nodejs,performance">
                    <img src="/placeholder.svg?height=200&width=400" alt="Node.js Best Practices"
                        class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-3">
                            <span class="bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full">Advanced</span>
                        ...
                        <p class="text-gray-600 mb-4">
                            Essential Node.js practices every developer should follow for building scalable and
                            maintainable applications.
                        </p>
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <img src="/placeholder.svg?height=32&width=32" alt="Mike Chen"
                                    class="w-8 h-8 rounded-full mr-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full">Node.js</span>
                            <span class="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full">Performance</span>
                        </div>
                    </div>
                </article>
                ...
                <!-- Article 3 -->
                <article class="article-card card-hover bg-white rounded-lg shadow-lg overflow-hidden fade-in"
                    data-title="Async/Await vs Promises: Complete Guide" data-author="Emily Rodriguez"
                    data-date="2024-12-10" data-views="3100" data-difficulty="beginner" data-tags="async,es6">
                    <img src="/placeholder.svg?height=200&width=400" alt="Async/Await Guide"
                        class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-3">
                            <span class="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">Beginner</span>
                            <span class="text-gray-500 text-sm">Dec 10, 2024</span>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-purple-600 transition-colors">
                            <a href="#">Async/Await vs Promises: Complete Guide</a>
                        </h3>
                        <p class="text-gray-600 mb-4">
                            Learn the differences between async/await and promises, when to use each, and best practices
                            for asynchronous JavaScript.
                        </p>
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <img src="/placeholder.svg?height=32&width=32" alt="Emily Rodriguez"
                                    class="w-8 h-8 rounded-full mr-3">
                                <span class="text-sm text-gray-700">Emily Rodriguez</span>
                            </div>
                            <div class="flex items-center text-gray-500 text-sm">
                                <i class="far fa-eye mr-1"></i>
                                <span>3.1K</span>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full">Async/Await</span>
                            <span class="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full">ES6+</span>
                        </div>
                    </div>
                </article>
                ...
                <!-- Article 4 -->
                <article class="article-card card-hover bg-white rounded-lg shadow-lg overflow-hidden fade-in"
                    data-title="JavaScript Testing with Jest: Advanced Techniques" data-author="David Kim"
                    data-date="2024-12-08" data-views="1500" data-difficulty="intermediate"
                    data-tags="testing,frameworks">
                    <img src="/placeholder.svg?height=200&width=400" alt="JavaScript Testing"
                        class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-3">
                            <span class="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full">Intermediate</span>
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-purple-600 transition-colors">
                            <a href="#">JavaScript Testing with Jest: Advanced Techniques</a>
                        </h3>
                        <p class="text-gray-600 mb-4">
                            Master advanced Jest testing techniques including mocking, snapshot testing, and testing
                            asynchronous code.
                        </p>
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <img src="/placeholder.svg?height=32&width=32" alt="David Kim"
                                    class="w-8 h-8 rounded-full mr-3">
                                <span class="text-sm text-gray-700">David Kim</span>
                            </div>
                            <div class="flex items-center text-gray-500 text-sm">
                                <i class="far fa-eye mr-1"></i>
                                <span>1.5K</span>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full">Testing</span>
                            <span class="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full">Frameworks</span>
                        </div>
                    </div>
                </article>
                ...
                <!-- Article 5 -->
                <article class="article-card card-hover bg-white rounded-lg shadow-lg overflow-hidden fade-in"
                    data-title="Building Modern JavaScript Frameworks" data-author="Lisa Wang" data-date="2024-12-05"
                    data-views="2700" data-difficulty="advanced" data-tags="frameworks,performance">
                    <img src="/placeholder.svg?height=200&width=400" alt="JavaScript Frameworks"
                        class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-3">
                            <span class="bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full">Advanced</span>
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-purple-600 transition-colors">
                            <a href="#">Building Modern JavaScript Frameworks</a>
                        </h3>
                        <p class="text-gray-600 mb-4">
                            Deep dive into the architecture and design patterns behind modern JavaScript frameworks and
                            how to build your own.
                        </p>
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <img src="/placeholder.svg?height=32&width=32" alt="Lisa Wang"
                                    class="w-8 h-8 rounded-full mr-3">
                                <span class="text-sm text-gray-700">Lisa Wang</span>
                            </div>
                            <div class="flex items-center text-gray-500 text-sm">
                                <i class="far fa-eye mr-1"></i>
                                <span>2.7K</span>
                ...
                <!-- Article 6 -->
                <article class="article-card card-hover bg-white rounded-lg shadow-lg overflow-hidden fade-in"
                    data-title="JavaScript Performance Optimization Tips" data-author="Alex Thompson"
                    data-date="2024-12-03" data-views="1900" data-difficulty="intermediate" data-tags="performance,es6">
                    <img src="/placeholder.svg?height=200&width=400" alt="Performance Optimization"
                        class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-3">
                            <span class="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full">Intermediate</span>
                        ...
                        <p class="text-gray-600 mb-4">
                            Learn practical techniques to optimize your JavaScript code for better performance and user
                            experience.
                        </p>
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <img src="/placeholder.svg?height=32&width=32" alt="Alex Thompson"
                                    class="w-8 h-8 rounded-full mr-3">
                                <span class="text-sm text-gray-700">Alex Thompson</span>
                            </div>
                            <div class="flex items-center text-gray-500 text-sm">
                                <i class="far fa-eye mr-1"></i>
                                <span>1.9K</span>
